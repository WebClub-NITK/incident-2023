const styles = {
    ...
    card:"h-auto w-[25rem] max-w-9/10  bg-dimMaroon  shadow-2  shadow-inner  shadow-black  rounded-lg  m-4 transition-all ease-in-out hover:translate-x-0.5 hover:-translate-y-0.5 hover:bg-gradient-to-br from-dimMaroon to-rose-900 duration-150",
  };
