        ...
        <div className='overflow-hidden relative'>
          <div className='flex ease-in p-5' >
            ...
            <div className='w-full h-full absolute top-0 left-0 z-0'>
                <button onClick={prevSlide} className='p-2  text-yellow-600 absolute top-1/2 left-0 z-10 rounded-full'>
            <ChevronLeft size={40}/>
            </button>
            <button onClick={nextSlide} className='p-2  text-yellow-600 p-1  absolute top-1/2 right-0 z-10 rounded-full'>
