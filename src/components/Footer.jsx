...
const Footer = () => {
  return (
    ...
    <div class="bg-light dark:bg-gray-900">
    <div class="container p-6 mx-auto" >
        <div class="lg:flex">
            <div class="w-full -mx-6 lg:w-1/5">
                <div class="px-6">
                    <a href="#">
                        <img class="w-auto " src="/src/assets/incilogo.png" alt=""/>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div>
                    ...
                    <div>
                        ...
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">Sponsers</a>
                        <a href="#" class="block mt-2 text-sm text-gray-600 dark:text-gray-400 hover:underline">I</a>
                    </div>
        ...
        <div>
            <p class="text-center text-gray-400 ">Created By Incident NITK |  2022 All rights reserved.</p>
        </div>
    </div>
</div>
  )
